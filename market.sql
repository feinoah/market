...
INSERT INTO `t_account_info` VALUES ('3', 'test3@carit.com', '873f0d6061d9551724058c7a89841404', '测试', '2', null, null, '0', null, null, null, null, null, '127.0.0.1', '2012-06-08 09:37:42', '1', '2012-06-08 09:37:42', '2012-06-04 11:40:53');
...
CREATE TABLE `t_application` (
  ...
  `features` varchar(500) DEFAULT NULL COMMENT '特性',
  `en_features` varchar(500) DEFAULT NULL COMMENT '特性',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_t_application_app_name` (`app_name`),
  UNIQUE KEY `idx_t_application_en_name` (`en_name`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_application
-- ----------------------------
INSERT INTO `t_application` VALUES ('4', '微信', 'WeChat', '4.0', '腾讯', 'icons/Sina Weibo_34290237617778_big.png', 'icons/Sina Weibo_34290237617778.png', '4', '4M', 'apks/WeChat_33097474760242.apk', '', '1', '0', '0', '2', '', '', '', '', null, null, null, '1', '2012-06-01 15:12:23', '2012-06-08 17:56:37');
INSERT INTO `t_application` VALUES ('7', '测试', 'test', '1', 'dfd', null, null, '4', null, 'apks/test_11059635420806.apk', '', '2', '0', '0', '0', '', '', '', '', null, null, null, '1', '2012-06-08 11:49:27', '2012-06-08 11:49:27');
INSERT INTO `t_application` VALUES ('8', '新浪微博', 'Sina Weibo', '3.1', '新浪科技', null, null, '4', '4', 'apks/Sina Weibo_3.1_34279176365492.apk', '', '0', '0', '0', '0', '', '', '', '', null, null, null, '1', '2012-06-08 18:12:26', '2012-06-08 18:16:18');
INSERT INTO `t_application` VALUES ('9', 'tttt', 'ffff', 'ff', 'ff', null, null, '4', null, 'apks/ffff_34339029650557.apk', '', '1', '0', '0', '0', '', '', '', '', null, null, null, '0', '2012-06-08 18:17:18', '2012-06-08 18:17:18');
...
CREATE TABLE `t_app_catalog` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_t_app_catalog_name` (`name`) USING BTREE,
  UNIQUE KEY `idx_t_app_catalog_en_name` (`en_name`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_app_catalog
-- ----------------------------
INSERT INTO `t_app_catalog` VALUES ('2', '车载', 'car', '车载应用 导航  地方', 'car navigater 爱的', '2', '0', '2012-05-20 12:25:46', '2012-05-29 09:49:49');
INSERT INTO `t_app_catalog` VALUES ('4', '生活', 'Live', '生活应用', null, '2', '1', '2012-05-20 14:20:16', '2012-06-08 16:29:09');
INSERT INTO `t_app_catalog` VALUES ('5', '娱乐', 'add', '', '', '4', '1', '2012-06-08 12:01:38', '2012-06-08 12:01:38');
INSERT INTO `t_app_catalog` VALUES ('6', '游戏', 'Game', '', '', '1', '1', '2012-06-08 12:22:33', '2012-06-08 12:22:33');
...
-- ----------------------------
INSERT INTO `t_app_comment` VALUES ('1', '1', '3', '6', '已有帐号', '1', '2012-06-08 09:37:51', '2012-06-08 09:37:51');
...
-- ----------------------------
INSERT INTO `t_app_version_file` VALUES ('3', '4', '2.9.1', '4M', 'apks\\Sina Weibo_2.9.1_28609486200226.apk', '2.9.1正式版\r\n1.内置5款滤镜特效,发图片更精彩。\r\n2.优化私信语音聊天功能。\r\n3.私信支持图片和文字同时发布。\r\n4.新增内置浏览器，浏览网页无需跳出微博。\r\n5.修复若干Bug，增强稳定性。', 'dddddddddddddd', '1', '2012-05-29 09:22:14', '2012-05-29 16:40:36');
INSERT INTO `t_app_version_file` VALUES ('4', '4', '3.1', '4M', 'apks/Sina Weibo_3.1_28203369060862.apk', ',', null, '1', '2012-06-01 16:35:29', '2012-06-01 16:35:29');
INSERT INTO `t_app_version_file` VALUES ('7', '7', '1', '4', 'apks/test_11059635420806.apk', '', '', '1', '2012-06-08 11:49:27', '2012-06-08 11:49:27');
INSERT INTO `t_app_version_file` VALUES ('8', '4', '4.0', '4M', 'apks/WeChat_33097474760242.apk', null, null, '1', '2012-06-08 17:56:37', '2012-06-08 17:56:37');
INSERT INTO `t_app_version_file` VALUES ('9', '8', '3.0', '4M', 'apks/Sina Weibo_34046823900336.apk', null, null, '1', '2012-06-08 18:12:26', '2012-06-08 18:12:26');
INSERT INTO `t_app_version_file` VALUES ('10', '8', '3.1', '4', 'apks/Sina Weibo_3.1_34279176365492.apk', null, null, '1', '2012-06-08 18:16:18', '2012-06-08 18:16:18');
INSERT INTO `t_app_version_file` VALUES ('11', '9', 'ff', 'fd', 'apks/ffff_34339029650557.apk', null, null, '0', '2012-06-08 18:17:18', '2012-06-08 18:17:18');
...
INSERT INTO `t_base_role` VALUES ('6', '测试', '测试', '2012-06-01 14:38:31', '2012-06-01 14:38:31');
...
INSERT INTO `t_base_role_module` VALUES ('6', '35');
INSERT INTO `t_base_role_module` VALUES ('1', '36');
INSERT INTO `t_base_role_module` VALUES ('6', '36');
INSERT INTO `t_base_role_module` VALUES ('1', '37');
INSERT INTO `t_base_role_module` VALUES ('6', '37');
INSERT INTO `t_base_role_module` VALUES ('1', '38');
INSERT INTO `t_base_role_module` VALUES ('6', '38');
INSERT INTO `t_base_role_module` VALUES ('1', '39');
INSERT INTO `t_base_role_module` VALUES ('6', '39');
...
-- ----------------------------
INSERT INTO `t_base_user` VALUES ('1', 'admin@admin.com', '7d2331557888b9c2d51ee1cb44df0ef2', '系统管理员', '系统管理员', '1', '2012-06-08 18:11:40', '2012-05-13 15:19:44', '1', '系统管理员', '127.0.0.1', '2012-06-08 18:11:40', null, null);

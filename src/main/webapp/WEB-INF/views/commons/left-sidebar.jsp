...
<div class="ym-g20 ym-gl left-container">
	<div id="sidebar" <c:if test="${param.index eq 2}">style="height:930px;"</c:if>>
		<dl>
			...
			<dt <c:if test="${param.index eq 5}">class="select"><span id="contact-sidebar"><spring:message code="Sidebar.bluetooth.contact"/></span></c:if><c:if test="${param.index!=5}">><a href="${ctx}/bluetooth?hl=${param.hl}" id="contact-sidebar"><spring:message code="Sidebar.bluetooth.contact"/></a></c:if></dt>
		</dl>
	</div>
</div>
...
$(function (){
	...
	$.getJSON('${ctx}/obd/${param.deviceId}/${param.accountId}', function(data) {
		 if(data=='null'||data==''){
...
function doPage(page){
	$('#rows').empty();
	$('#pageDiv').empty();
	var search_url='${ctx}/obd/search/${param.deviceId}/${param.accountId}/'+index+'?page='+page+'&rows=5';
	if($('#startTime').val()){
